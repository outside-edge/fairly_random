...
LalRUtils::libreq(tidyverse, stargazer2, lfe, rio,
  foreach, magrittr, data.table) #,  lib2)
theme_set(lal_plot_theme())
options(repr.plot.width=12, repr.plot.height=9)
LalRUtils::libreq(tidyverse, stargazer2, lfe, rio, janitor, tictoc, broom,
  foreach, magrittr, data.table, ggstatsplot)
...
# %%
coef(reduced_form)/coef(first_stage)
coef(iv_est)
...
# %% [markdown]
# More subgroup analysese here [team, rank decile, etc]
