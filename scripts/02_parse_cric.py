...
results = simplejson.loads(open('matches-t20.json').read())

##################################START PROCESSING DATA#########################################
with open("t20_output.csv", "wb") as csvfile:
    ...
    for result in results:
        ...
        try:
            ...
            if m.rain_rule() == 'D/L method':
                ...
                duckworth_lewis = 0
            [ump_1, ump_2] = [o for o in m.officials() if o['player_type_name'] == 'umpire']
