...
In cricket matches, three results are possible: a draw, a win, and a loss. For now, we focus on winning and losing. We look at draws, a common outcome in matches in which overs aren't limited, later on. We elide over differential number of draws across formats, estimating the difference in probability of winning and losing. 
