...
```{r}
fs_by_group = reg_by_group(regsamp, type_of_match2,
    formula_lfe('bat_first', 'wintoss', C = "mid")) %>% rbindlist
coefplotter(fs_by_group[term == "wintoss"], "First Stage - Effect of Toss on Choice to bat first")
```
...
glue::glue("underdog share among compliers = {kappa_avg('underdog')}")
glue::glue("dn share among compliers = {kappa_avg('dn')}")
glue::glue("home share among compliers = {kappa_avg('home')}")
```
